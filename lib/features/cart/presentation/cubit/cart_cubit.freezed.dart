...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({final List<CartItem> cartItems = const []})
...
abstract class _Success implements CartState {
  const factory _Success({final List<CartItem> cartItems}) = _$SuccessImpl;
...
class _$FailureImpl implements _Failure {
  ...
  @override
  String toString() {
    return 'CartState.failure(exception: $exception)';
  }
